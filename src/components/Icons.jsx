...
export const CoffeeIcon = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6H18a2.25 2.25 0 012.25 2.25v0a2.25 2.25 0 01-2.25 2.25h-.75m-10.5 0h7.5m-7.5 0V6m0 4.5v6.75A2.25 2.25 0 009.75 19.5h4.5a2.25 2.25 0 002.25-2.25V10.5m-9 0h9" />
  </svg>
);
...
export const SportIcon = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    <circle cx="12" cy="12" r="9" />
    <path strokeLinecap="round" d="M12 3c2.5 3 2.5 9 0 12s-2.5 3 0 6M3 12h18M5.5 6c2 2 9 2 13 0M5.5 18c2-2 9-2 13 0" />
  </svg>
);
...
// FAZ 1 - Yeni ikonlar (Mevcut kodlar korundu)
...
export const StoryIcon = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
